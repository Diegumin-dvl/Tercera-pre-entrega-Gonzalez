...
def remerasForm(request):
    if request.method == "POST":
        miFormulario = RemerasForm(request.POST) # Aca me llega la informacion del html
        print(miFormulario)
...
def buzosForm(request):
    if request.method == "POST":
        miFormulario = BuzosForm(request.POST) # Aca me llega la informacion del html
        print(miFormulario)
...
def pantalonesForm(request):
    if request.method == "POST":
        miFormulario = PantalonesForm(request.POST) # Aca me llega la informacion del html
        print(miFormulario)
